            ...
            <tr>
                <td class="bg_dark email-section" style="text-align:center;">
                    <div class="heading-section heading-section-white">
                        <h2>Hello ${Name}</h2>
                        <p>
                            To recover your account follow the instructions below.
                        </p>
                    </div>
                </td>
            </tr>
                                    ...
                                    <tr>
                                        <td class="bg_white email-section" style="align-items: center;">
                                            <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                                <p>
                                                    To change the password on your account, click the button below </p>
                                            </div>
                                            <a href="localhost:3000/changePassword?email=${Email}&nick=${Name}" style="text-decoration: none;">
                                                <div class="button btn1">CHANGE PASSWORD</div>
                                            </a>
                                            ...
                                            <a href="localhost:3000/confirm?email=${Email}&nick=${Name}" style="color: rgba(0, 0, 0, 0.8);margin: 0 auto;;">
                                                localhost:3000/changePassword?email=${Email}&nick=${Name}
                                            </a>
